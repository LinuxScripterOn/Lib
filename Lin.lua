    ...
    function LinuxLib.Tab(config)
        ...
        local function SelectTab()
            for _, tab in pairs(Tabs) do
                ...
                tab.Text.TextColor3 = Color3.fromRGB(180, 180, 190)
                ...
                if tab.Icon then
                    tab.Icon.ImageColor3 = Color3.fromRGB(180, 180, 190)
                end
            end
        ...
        function TabElements.Button(config)
            ...
            local clickColor = Color3.fromRGB(100, 59, 154)
        ...
        function TabElements.Toggle(config)
            ...
            local function UpdateToggle()
                ...
                if State then
                    ...
                    TweenService:Create(ToggleBox, tween, {BackgroundColor3 = Color3.fromRGB(30, 30, 36)}):Play()
                else
        ...
        function TabElements.Dropdown(config)
                ...
                if IsOpen then
                    for _, opt in pairs(Options) do
                        local OptBtn = Linux.Instance("TextButton", {
                            ...
                            Font = Enum.Font.Code,
                            Text = tostring(opt),
                            TextColor3 = opt == SelectedValue and Color3.fromRGB(180, 180, 190) or Color3.fromRGB(100, 100, 110),
                            TextSize = 14,
                        ...
                        OptBtn.MouseButton1Click:Connect(function()
                            ...
                            for _, btn in pairs(DropFrame:GetChildren()) do
                                if btn:IsA("TextButton") then
                                    btn.TextColor3 = btn.Text == tostring(opt) and Color3.fromRGB(180, 180, 190) or Color3.fromRGB(100, 100, 110)
                                end
                            end
            ...
            local function SetValue(value)
                if table.find(Options, value) then
                    ...
                    for _, btn in pairs(DropFrame:GetChildren()) do
                        if btn:IsA("TextButton") then
                            btn.TextColor3 = btn.Text == tostring(value) and Color3.fromRGB(180, 180, 190) or Color3.fromRGB(100, 100, 110)
                        end
                    end
                    Linux:SaveConfig("Dropdown_" .. config.Name, SelectedValue, shouldSave, configFolder)
