...
local Themes = {
    Default = {
        ...
        WindowBackground = Color3.fromRGB(19, 19, 19),
        WindowBorder = Color3.fromRGB(255, 255, 255),
        TabBackground = Color3.fromRGB(22, 22, 22),
        TabBorder = Color3.fromRGB(255, 255, 255),
        TabToggleBackground = Color3.fromRGB(22, 22, 22),
        ...
        ObjectBackground = Color3.fromRGB(22, 22, 22),
        ObjectBorder = Color3.fromRGB(50, 50, 50),
        DropdownOptionBackground = Color3.fromRGB(27, 27, 27)
    },
    Midnight = {
        Accent = Color3.fromRGB(100, 59, 154),
        WindowBackground = Color3.fromRGB(30, 30, 36),
        WindowBorder = Color3.fromRGB(45, 45, 49),
        TabBackground = Color3.fromRGB(20, 20, 24),
        TabBorder = Color3.fromRGB(45, 45, 55),
        TabToggleBackground = Color3.fromRGB(28, 28, 32),
        SectionBackground = Color3.fromRGB(18, 18, 22),
        SectionBorder = Color3.fromRGB(35, 35, 45),
        Text = Color3.fromRGB(180, 180, 190),
        DisabledText = Color3.fromRGB(100, 100, 110),
        ObjectBackground = Color3.fromRGB(25, 25, 29),
        ObjectBorder = Color3.fromRGB(35, 35, 39),
        DropdownOptionBackground = Color3.fromRGB(19, 19, 23)
    }
}
...
function Linux:Notify(config)
    ...
    local Notification = Linux.Instance("Frame", {
        ...
        BorderColor3 = theme.WindowBorder,
        BorderSizePixel = 2,
...
function Linux.Create(config)
    ...
    local shadowOffset = 12
    local shadowSize = UDim2.new(0, uiSize.X.Offset + shadowOffset, 0, uiSize.Y.Offset + shadowOffset)

    local MainShadow = Linux.Instance("ImageLabel", {
        Parent = LinuxUI,
        BackgroundTransparency = 1,
        Size = shadowSize,
        Position = UDim2.new(0.5, -(uiSize.X.Offset + shadowOffset) / 2, 0.5, -(uiSize.Y.Offset + shadowOffset) / 2),
        Image = "rbxassetid://1316045217",
        ImageColor3 = Color3.fromRGB(0, 0, 0),
        ImageTransparency = 0.8,
        ScaleType = Enum.ScaleType.Slice,
        SliceCenter = Rect.new(10, 10, 246, 246),
        ZIndex = 0,
        BorderSizePixel = 1,
    ...
    Main.InputBegan:Connect(function(input)
        if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
            dragConnection = RunService.RenderStepped:Connect(UpdateShadowPosition)
        end
    end)
    ...
    local Content = Linux.Instance("Frame", {
        ...
        ZIndex = 1,
        BorderSizePixel = 2,
        BorderColor3 = theme.SectionBorder
    })
    ...
    InputService.InputBegan:Connect(function(input)
        if input.KeyCode == Enum.KeyCode.LeftAlt then
            ...
            MainShadow.Visible = not isHidden
        end
    end)
    ...
    function LinuxLib.Tab(config)
        ...
        local function SelectTab()
            for _, tab in pairs(Tabs) do
                ...
                tab.Text.TextColor3 = theme.Text
            ...
            TabBtn.BackgroundColor3 = theme.WindowBackground
            TabGradient = Linux.Instance("UIGradient", {
                Parent = TabBtn,
                Color = ColorSequence.new({
                    ColorSequenceKeypoint.new(0, theme.Accent),
                    ColorSequenceKeypoint.new(1, Color3.fromRGB(theme.Accent.R * 255 * 0.7, theme.Accent.G * 255 * 0.7, theme.Accent.B * 255 * 0.7))
                }),
                Rotation = 45
            })
            if TabIcon then
        ...
        function TabElements.Button(config)
            ...
            local BtnFrame = Linux.Instance("Frame", {
                Parent = container,
                BackgroundColor3 = theme.ObjectBackground,
                BorderColor3 = theme.ObjectBorder,
                BorderSizePixel = 2,
            ...
            local hoverColor = Color3.fromRGB(theme.ObjectBackground.R * 255 * 1.2, theme.ObjectBackground.G * 255 * 1.2, theme.ObjectBackground.B * 255 * 1.2)
            local clickColor = theme.Accent
            local originalColor = theme.ObjectBackground
        ...
        function TabElements.Toggle(config)
            ...
            local function UpdateToggle()
                ...
                if State then
                    ...
                    TweenService:Create(ToggleBox, tween, {BackgroundColor3 = theme.WindowBackground}):Play()
                else
        ...
        function TabElements.Dropdown(config)
                ...
                if IsOpen then
                    for _, opt in pairs(Options) do
                        local OptBtn = Linux.Instance("TextButton", {
                            ...
                            Font = Enum.Font.Gotham,
                            Text = tostring(opt),
                            TextColor3 = opt == SelectedValue and theme.Text or theme.DisabledText,
                            TextSize = 14,
                        ...
                        OptBtn.MouseButton1Click:Connect(function()
                            ...
                            for _, btn in pairs(DropFrame:GetChildren()) do
                                if btn:IsA("TextButton") then
                                    btn.TextColor3 = btn.Text == tostring(opt) and theme.Text or theme.DisabledText
                                end
                            end
            ...
            local function SetValue(value)
                if table.find(Options, value) then
                    ...
                    for _, btn in pairs(DropFrame:GetChildren()) do
                        if btn:IsA("TextButton") then
                            btn.TextColor3 = btn.Text == tostring(value) and theme.Text or theme.DisabledText
                        end
                    end
                    Linux:SaveConfig("Dropdown_" .. config.Name, SelectedValue, shouldSave, configFolder)
        ...
        function TabElements.Input(config)
            ...
            container.CanvasPosition = Vector2.new(0, 0)
            return {
                Instance bandwidth usage for each user in real time, ensuring accurate monitoring without disrupting the user experience. Input,
                SetValue = SetValue,
