...
function Linux:Notify(config)
    ...
    local Notification = Linux.Instance("Frame", {
        ...
        BorderColor3 = Color3.fromRGB(45, 45, 49),
        BorderSizePixel = 2,
    ...
    local ProgressFill = Linux.Instance("Frame", {
        Parent = ProgressBar,
        BackgroundColor3 = Color3.fromRGB(100, 59, 154),
...
function Linux.Create(config)
    ...
    function LinuxLib.Tab(config)
        ...
        local TabBtn = Linux.Instance("TextButton", {
            ...
            BorderColor3 = Color3.fromRGB(35, 35, 39),
            BorderSizePixel = 2,
        ...
        local Container1ListLayout = Linux.Instance("UIListLayout", {
            Parent = Container1,
            Padding = UDim.new(0, 3),
            HorizontalAlignment = Enum.HorizontalAlignment.Left,
            SortOrder = Enum.SortOrder.LayoutOrder
        ...
        local Container2ListLayout = Linux.Instance("UIListLayout", {
            Parent = Container2,
            Padding = UDim.new(0, 3),
            HorizontalAlignment = Enum.HorizontalAlignment.Left,
            SortOrder = Enum.SortOrder.LayoutOrder
        ...
        local function SelectTab()
            for _, tab in pairs(Tabs) do
                ...
                tab.Text.TextColor3 = Color3.fromRGB(190, 190, 190)
                tab.Button.BackgroundColor3 = Color3.fromRGB(25, 25, 29)
                ...
                if tab.Icon then
                    tab.Icon.ImageColor3 = Color3.fromRGB(190, 190, 190)
                end
            end
            TabContent.Visible = true
            TitleFrame.Visible = true
            TabText.TextColor3 = Color3.fromRGB(190, 190, 190)
            TabBtn.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
            TabGradient = Linux.Instance("UIGradient", {
                Parent = TabBtn,
                Color = ColorSequence.new({
                    ColorSequenceKeypoint.new(0, Color3.fromRGB(100, 59, 154)),
                    ColorSequenceKeypoint.new(1, Color3.fromRGB(70, 41, 108))
                }),
                Rotation = 45
            })
            if TabIcon then
                TabIcon.ImageColor3 = Color3.fromRGB(190, 190, 190)
            end
            CurrentTab = tabIndex
        ...
        local lastWasDropdown1 = false
        local lastWasDropdown2 = false
        ...
        function TabElements.Button(config)
            ...
            if config.Container == 2 then
                ...
                if lastWasDropdown2 then
                    Container2ListLayout.Padding = UDim.new(0, 1)
                else
                    Container2ListLayout.Padding = UDim.new(0, 3)
                end
                lastWasDropdown2 = false
            else
                elementOrder1 = elementOrder1 + 1
                if lastWasDropdown1 then
                    Container1ListLayout.Padding = UDim.new(0, 1)
                else
                    Container1ListLayout.Padding = UDim.new(0, 3)
                end
            ...
            local originalColor = Color3.fromRGB(25, 25, 29)
        ...
        function TabElements.Dropdown(config)
            ...
            if config.Container == 2 then
                elementOrder2 = elementOrder2 + 1
                lastWasDropdown2 = true
            else
                elementOrder1 = elementOrder1 + 1
                lastWasDropdown1 = true
            end
                ...
                if IsOpen then
                    for _, opt in pairs(Options) do
                        local OptBtn = Linux.Instance("TextButton", {
                            ...
                            Font = Enum.Font.Code,
                            Text = tostring(opt),
                            TextColor3 = opt == SelectedValue and Color3.fromRGB(205, 205, 205) or Color3.fromRGB(130, 130, 130),
                            TextSize = 14,
                        ...
                        OptBtn.MouseButton1Click:Connect(function()
                            ...
                            Selected.TextColor3 = Color3.fromRGB(205, 205, 205)
                            for _, btn in pairs(DropFrame:GetChildren()) do
                                if btn:IsA("TextButton") then
                                    btn.TextColor3 = btn.Text == tostring(opt) and Color3.fromRGB(205, 205, 205) or Color3.fromRGB(130, 130, 130)
                                end
                            end
            ...
            local function SetValue(value)
                if table.find(Options, value) then
                    ...
                    for _, btn in pairs(DropFrame:GetChildren()) do
                        if btn:IsA("TextButton") then
                            btn.TextColor3 = btn.Text == tostring(value) and Color3.fromRGB(205, 205, 205) or Color3.fromRGB(130, 130, 130)
                        end
                    end
                    Linux:SaveConfig("Dropdown_" .. config.Name, SelectedValue, shouldSave, configFolder)
